...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Main = React.createClass({
		...
		setTerm: function setTerm(topic, sYear, eYear) {
			this.setState({
				topic: topic,
				startYear: sYear,
				endYear: eYear
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'jumbotron', style: { 'backgroundColor': '#61a0d6', 'color': '#FFFFFF' } },
						React.createElement(
							'h2',
							{ className: 'text-center', style: { 'color': '#FFFFFF', 'fontSize': '54px' } },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// New York Times API
	var nytAPI = "a40f474160df41ae8c9e9608ab4db4b4";
